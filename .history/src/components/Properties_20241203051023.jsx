  ...
  return (
    <>
      <div className="text-center">
        <h2 className="text-4xl font-semibold ">Crafted with love And care</h2>
        <p className="text-lg text-gray-500  w-full text-center mt-4">
          We use materials that are organically grown and naturally sourced
          ingredients.
        </p>
        <p className="text-lg text-gray-500 mb-16 w-full text-center mt-2">
          All our products are tested to ensure they are safe and maintain the
          standard benchmark.
        </p>
      </div>
      <div className=" relative border-t-2 border-b-2 border-gray-200 py-8">
        <div className="flex  justify-between gap-2 mt-4 mb-4">
          ...
          {/* Image 5 */}
          <div className="flex justify-center items-center w-1/6 md:w-1/6">
            <img src={p2} alt="Handcrafted" className="max-w-full h-auto" />
            <p className="absolute bottom-[100px] text-amber-800 font-bold">
              Hand
            </p>
            <p className="absolute bottom-[80px] text-amber-800 font-bold">
              Crafted
            </p>
          </div>
