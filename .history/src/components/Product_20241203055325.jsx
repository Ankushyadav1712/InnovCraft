...
const Product = ({ product }) => {
  return (
    <div className=" bg-white shadow-lg rounded-lg p-4 max-w-sm ml-10 ">
      {/* Sale Badge */}
      {product.onSale && (
        <span className=" top-1 left-2 bg-white border rounded-lg text-green-900 text-xs font-bold px-2 py-1 ">
          Sale!
        </span>
      )}
