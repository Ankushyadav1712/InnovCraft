      ...
      <div className=" relative border-t-2 border-b-2 border-gray-200 py-8">
        <div className="flex  justify-between gap-2 mt-4 mb-4">
          ...
          <div className="flex justify-center items-center w-1/6 md:w-1/6">
            ...
            <p className="absolute bottom-[100px] text-amber-900 font-bold">Hand</p>
            <p className="absolute bottom-[80px] text-amber-900 font-bold">Crafted</p>
          </div>
          ...
          <div className="flex justify-center items-center w-1/6 md:w-1/6">
            ...
            />
            <p className="absolute bottom-[100px]  text-amber-900 font-bold"">Chemical</p>
            <p className="absolute bottom-[80px]">Free</p>
          </div>
