...
const CraftingCare = () => {
  return (
    <div className="px-6 py-12">
      {/* Title Section */}
      <h2 className="text-4xl font-bold text-center mb-8 mt-16">
      ...
      <div className="flex items-center justify-between mb-12 rounded-full overflow-hidden bg-gray-100 shadow-lg h-[500px]">
        ...
        <div className="w-1/2 p-6">
          ...
          <button className="px-6 py-2 bg-amber-700 border border-spacing-1 text-white rounded-full hover:bg-amber-800 transition duration-300 pl-12">
            Know More
          </button>
        </div>
      </div>
