...
const Subscribe = () => {
  return (
    <div>
      <section
        className="relative bg-cream text-center py-10 px-4 sm:px-8 md:px-16 lg:px-32"
      >
        {/* Subscription Content */}
        <div className="relative z-10 bg-white rounded-lg shadow-lg px-6 py-10 overflow-hidden"
        style={{
