    ...
    <footer className="bg-green-900 text-white py-10">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="mb-8">
          ...
          />
          <p className="font-bold text-lg sm:text-xl">ABHYANJANA</p>
          <p className="text-sm sm:text-base italic">WELLNESS SIMPLIFIED</p>
        </div>
        ...
        <div className="mb-8 flex justify-center space-x-6">
          ...
          <a href="#youtube" aria-label="YouTube" className="hover:text-gray-300">
