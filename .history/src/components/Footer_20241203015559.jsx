          ...
          <div className="mb-8 flex justify-center space-x-6">
            ...
            >
              <div className="flex items-center justify-center w-10 h-10 bg-gray-200 rounded-full">
                <i className="fab fa-instagram text-xl sm:text-2xl text-black"></i>
              </div>
            </a>
            <a
              href="#facebook"
              ...
              className="hover:text-gray-300"
            >
              <div className="flex items-center justify-center w-10 h-10 bg--200 rounded-full">
                <i className="fab fa-facebook text-xl sm:text-2xl text-black"></i>
              </div>
            </a>
            <a
              href="#youtube"
            ...
            >
              <div className="flex items-center justify-center w-10 h-10 bg-gray-200 rounded-full">
                <i className="fab fa-youtube text-xl sm:text-2xl text-black"></i>
              </div>
            </a>
          </div>
