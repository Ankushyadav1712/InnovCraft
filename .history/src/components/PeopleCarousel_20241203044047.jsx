...
import frame5 from "../assets/MicrosoftTeams-image-76.png";
import frame6 from "../assets/MicrosoftTeams-image-77.png";
...
const PeopleCarousel = () => {
  ...
  return (
    <div>
      <h2 className="text-4xl  text-center mb-6 mt-20 text-green-900">
