...
const Products = () => {
  return (
    <div className="p-8">
      <h2 className="text-4xl  text-center mb-8 text-green-900 mt-16">
        Our Products
      </h2>

      {/* Products Grid */}
      <div className="flex flex-wrap gap-10 justify-center items-center h-[350px] w-[350px] mt-[100px] flex-col">
