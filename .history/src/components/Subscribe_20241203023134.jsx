        ...
        >
          ...
          <form className="mt-6 flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <input
              type="email"
              placeholder="Email"
              className="w-0.5 sm:w-2/3 px-4 py-2 border rounded-full focus:outline-none focus:ring-2 focus:ring-green-600"
            />
            <button
              type="submit"
              className="w-full sm:w-auto bg-amber-900 text-white px-6 py-2 rounded-full hover:bg-amber-900 focus:outline-none focus:ring-2 focus:ring-amber-600"
            >
              Subscribe
            </button>
          </form>
