    ...
    <div className="">
      ...
      >
        {heroData.map((item) => (
          <div
            key={item.id}
            className="relative h-[700px] bg-cover bg-center flex items-center px-6"
            style={{ backgroundImage: `url(${item.bgUrl})` }}
          >
            <div className="text-left max-w-md text-white ml-10">
              ...
              <button className="px-8 py-3 bg-amber-800 text-white rounded-md hover:bg-amber-700 transition duration-300 mt-10">
                Order Now
              </button>
            </div>
          </div>
